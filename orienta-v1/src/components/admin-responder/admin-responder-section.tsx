...
import { AdminResponderHero } from "@/components/admin-responder/admin-responder-hero";
...
/**
 * "Responder por organização" no admin.
 *
 * Mostra cada organização com seus formulários ativos e leva ao workbench
 * em `/admin/responder/[formId]?orgId=...`. Substitui o antigo fluxo de
 * `/analista/formularios` que misturava modelos cadastrados com responder
 * por org — modelos agora ficam em `/admin/formularios`.
 */
export function AdminResponderSection({ groupsWithForms }: Props) {
  return (
    <div className={layout.pageStack}>
      ...
      <div className={`${layout.pageStack} pt-1`}>
              ...
              <div className="flex min-w-0 items-start gap-3">
                ...
                <div className="min-w-0">
                  ...
                  <p className="mt-1 text-sm leading-relaxed text-slate-600">
                    Escolha a organização e o formulário. As respostas ficam vinculadas a
                    ela, com a sua autoria de administrador.
                  </p>
                </div>
              </div>
            </div>
                        ...
                        {group.forms.map((f) => {
                          ...
                          return (
                            ...
                            >
                              ...
                              <Link
                                href={`/admin/responder/${f.formId}?orgId=${group.organizationId}`}
        ...
        <p
          ...
          role="note"
        >
          Respostas gravadas por aqui permanecem com a sua autoria; o vínculo é sempre com
          a organização selecionada no fluxo de resposta.
        </p>
      </div>
    </div>
  );
