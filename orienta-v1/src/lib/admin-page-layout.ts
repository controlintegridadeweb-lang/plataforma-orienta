...
/** Hero institucional das páginas admin (sem gradiente). */
export const ADMIN_PAGE_HERO_CLASS =
  "relative overflow-hidden rounded-t-2xl border-b border-slate-200/40 bg-white";
