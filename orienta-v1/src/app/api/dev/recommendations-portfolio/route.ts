...
/** Atalho de desenvolvimento; em producao use GET /api/recommendations/portfolio. */
export async function GET(request: Request) {
  ...
  try {
    ...
    logError("Failed to load recommendations portfolio", error, {
      route: "/api/dev/recommendations-portfolio",
    });
    const message =
